...
class ListStoryRemoteMediator(private val database: ListStoryDatabase, private val apiService: ApiService) : RemoteMediator<Int, ListStoryItem>(){
        ...
        try {
            ...
            database.withTransaction {
                if (loadType == LoadType.REFRESH) {
                    ...
                    database.listStoryDao().deleteAll()
                }
                ...
                responseData?.let {
                    database.listStoryDao().insertStory(it)
                }
            }
